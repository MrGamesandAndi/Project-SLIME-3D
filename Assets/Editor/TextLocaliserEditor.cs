...
public class TextLocaliserEditWindow : EditorWindow
{
    ...
    {
        var window = (TextLocaliserEditWindow)CreateInstance(typeof(TextLocaliserEditWindow));
...
public class TextLocaliserSearchWindow : EditorWindow
{
    ...
    {
        var window = (TextLocaliserSearchWindow)CreateInstance(typeof(TextLocaliserSearchWindow));
